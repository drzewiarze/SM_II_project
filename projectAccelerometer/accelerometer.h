...
#define MMA8451Q_REG_CTRL_REG4  0x2D    /* interrupt sources mapped to INT2 pin */
#define MMA8451Q_REG_CTRL_REG5  0x2E    /* configuration of interrupt behavior */
...
/**
 * @brief Configure interrupt for INT2 pin. Configures the pin to trigger an interrupt on a specific event.
