...
// Deklaracja struktury do przechowywania danych akcelerometru
struct accelerometer_data_t {
    double x; // Przyspieszenie na osi X
    double y; // Przyspieszenie na osi Y
    double z; // Przyspieszenie na osi Z
};
/**
