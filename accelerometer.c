...
void Accelerometer_ReadData(struct accelerometer_data_t *data) {
    ...
    data->y = ((double)((int16_t)((arrayXYZ[2]<<8)|arrayXYZ[3])>>2)/(4096>> MMA8451Q_RANGE_2g)); // Convert 14-bit Y data
    data->z = ((double)((int16_t)((arrayXYZ[4]<<8)|arrayXYZ[5])>>2)/(4096>> MMA8451Q_RANGE_2g)); // Convert 14-bit Z data
}
/**
